...
export const backendNetworkChangedAsync: (interfaceName: string) => Promise<string>;
...
export const backendTaildriveManualDownloadAsync: (request: string) => Promise<string>;
